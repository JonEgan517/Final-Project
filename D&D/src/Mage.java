...
public class Mage
	{
		...
		public static void mage()
			{
				direction = JOptionPane.showInputDialog("You enter the dungeon as a "+Dungeon.character.get(1).getName()
						...
						if (direction.equals("Left") || direction.equals("left"))
							...
							sum = Dungeon.character.get(1).getHp() + Dungeon.character.get(1).getAttack();
							add = health + strength;
								...
								JOptionPane.showMessageDialog(frame, "You found a magical wand which gives you more attack damage. "
								+ "You also saved the kingdom as a " +Dungeon.character.get(1).getName()+ ".");
								}
